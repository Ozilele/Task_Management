...
from .views import AssignedProjectList, CreatedProjectList, TaskListCreate, TaskDelete, TaskUpdate, TaskItem, AssignedTaskList, CreatedTaskList
...
urlpatterns = [
    ...
    path("projects/<int:project_id>/tasks/", TaskListCreate.as_view(), name="project-tasks"), # get all tasks for given project, create task for given project
    ...
    path("projects/<int:project_id>/created/", CreatedTaskList.as_view(), name="project-created-tasks"),
